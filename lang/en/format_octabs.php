...
/**
 * Strings for component 'format_octabs', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   format_octabs
 * @copyright 2015 oncampus
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
$string['pluginname'] = 'oc- Tabs Format';
$string['nameoctabs'] = 'oc Week';
...
$string['sectionname'] = 'Moodle oc Tab';
...
$string['formatoc'] = 'oc Tabs'; // Name to display for format
$string['nameoc'] = 'Week'; // Name of a section within your format

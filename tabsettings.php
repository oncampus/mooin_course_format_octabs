...
$PAGE->set_url('/course/format/octabs/tabsettings.php', array('id' => $id));
...
$editform = new course_octabs_edit_form(NULL, array('course' => $course), 'post', '', array('class' => 'fn_tabs_settings'));
                                  
$data = new stdClass();
$data->courseid = $course->id;
$mainheading = $DB->get_field('course_config_fn', 'value', array('courseid' =>$data->courseid, 'variable' => 'mainheading'));
$data->mainheading = ($mainheading) ? $mainheading: get_string('defaultmainheading', 'format_octabs');

$topicheading = $DB->get_field('course_config_fn', 'value', array('courseid' =>$data->courseid, 'variable' => 'topicheading'));
$data->topicheading = ($topicheading) ? $topicheading: get_string('defaulttopicheading', 'format_octabs');
